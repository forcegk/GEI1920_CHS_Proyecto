...
SC_MODULE ( fingeEntradaExterna ) { // solo se utiliza con el m�dulo de filtrado, en las dem�s hay que ponerla igualmente
public:
...
class top : public sc_module
{
	...
	SC_CTOR(top) // constructor
	{
		...
		for(i=0; i<2; ++i){	// una iteraci�n m�s que el n�mero de procesadores
